    ...
    <div className="space-y-6">
      ...
      >
        <Button
          ...
          className=" cursor-pointer w-full py-7 text-xl bg-gradient-to-r from-sky-500 to-teal-500 hover:from-sky-600 hover:to-teal-600 text-white rounded-2xl shadow-lg hover:shadow-xl hover:shadow-sky-500/20 transition-all duration-300"
        >
